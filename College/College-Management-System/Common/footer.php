    ...
    <div class="container">
        <div class="row">
          <div class="col-md-3 col-sm-6 col-xs-12 segment-one md-mb-30 sm-mb-30">
            ...
            <p>This Project has been made by vartika tripathi & Suryansh Srijan.
          ...
          <div class="col-md-3 col-sm-6 col-xs-12 segment-two md-mb-30 sm-mb-30">
            <h2>CONTACT DETAILS</h2>
              <p>Address: college of engineering
                vinayaka layout,whitefeild–bangalore 560066</p>
              <p>Telephones:080-4222-9748</p>
              <p>E-mail: engineering@college.edu.pk</p>
        </div>
      </div>
    </div>
    </div>
