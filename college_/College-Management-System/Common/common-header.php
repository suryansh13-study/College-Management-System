...
<html lang="en">
	<head>
    <meta charset="utf-8">
    <link rel="shortcut icon" href="$baseUrl/../Images/imperial-banner.png" type="image/x-icon">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark header-back sticky-top header-navbar-fonts">
      <a class="navbar-brand d-flex align-items-center" href="../index.php">
        <img src="../images/imperial-banner.png" class="logo-image" width="50" height="50">
        <h3 class="text-light text-uppercase ml-2">College of Engineering</h3>
      </a>
